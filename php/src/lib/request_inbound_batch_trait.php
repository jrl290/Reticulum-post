    ...
    private function processInboundBatchRow(array $row, array &$summary): void
    {
        ...
        foreach ($packets as $packetBase64) {
            ...
            try {
                ...
                // Inbound hop increment — matches Python Transport.inbound()
                // line 1398 and Rust transport.rs line 4438.
                // Every packet passing through a transport node gets +1 hop.
                // See HOPS.md Golden Rule and §5 Bug #3.
