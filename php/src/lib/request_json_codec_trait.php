...
trait RequestJsonCodecTrait
{
    ...
    {
        $encoded = json_encode($value, JSON_THROW_ON_ERROR | JSON_PARTIAL_OUTPUT_ON_ERROR);
    ...
    {
        $decoded = json_decode($json, true, flags: JSON_THROW_ON_ERROR | JSON_PARTIAL_OUTPUT_ON_ERROR);
